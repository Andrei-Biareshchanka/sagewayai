...
const translations = {
  en: {
    ...
    alreadySubscribed: 'You are already subscribed. You will receive a daily parable every morning.',
    subscribed: 'Subscribed! You will receive a daily parable every morning at 8:00. 🌿',
  ...
  ru: {
    welcome: 'Добро пожаловать в SagewayAI 🌿\n\nЕжедневная притча, которая откликается.',
    dailyButton: '📖 Притча дня',
    subscribeButton: '🔔 Подписаться',
    unsubscribeButton: '🔕 Отписаться',
    alreadySubscribed: 'Вы уже подписаны. Вы будете получать притчу каждое утро.',
    subscribed: 'Подписка оформлена! Вы будете получать притчу каждое утро в 8:00. 🌿',
