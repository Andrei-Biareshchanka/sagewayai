...
| 36 | urok-reki | image depicts a human traveler; RU/EN text has no human character (personified river dialogue with a "voice"). Self-consistent alt/image, but a stylistic substitution not present in the source text. | — (flagged, not auto-fixed) | **open — awaiting user decision** |
