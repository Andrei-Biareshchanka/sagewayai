  ...
  return (
    <main className="flex min-h-[80vh] items-center justify-center px-6">
      <div className="w-full max-w-[400px]">
        <h1 className="mb-2 font-serif text-3xl font-semibold text-[#1A1A1A]">Create account</h1>
        <p className="mb-8 text-sm text-[#6B7280]">
          Already have an account?{' '}
          <Link to="/login" className="text-[#6B8F71] hover:underline">
            Sign in
          </Link>
        </p>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            <label htmlFor="password" className="text-sm font-medium text-[#1A1A1A]">
              Password
              <span className="ml-1 font-normal text-[#6B7280]">(min 8 characters)</span>
            </label>
            <input
              id="password"
              type="password"
